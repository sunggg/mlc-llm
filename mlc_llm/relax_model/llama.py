...
class LlamaForCausalLM(nn.Module):
    def __init__(self, config: LlamaConfig, sep_embed: bool = False):
        ...
        self.cos_cached = nn.Parameter((2048, head_dim), dtype=config.dtype, name="cos_cached")
        self.sin_cached = nn.Parameter((2048, head_dim), dtype=config.dtype, name="sin_cached")
        ############ End ############
...
def get_model(args, hf_config):
    ...
    print(param_manager.param_names)
    assert 0
    device = tvm.cpu()
